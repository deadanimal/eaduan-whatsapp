...
<head>
    ...
    <link rel="stylesheet" href="{{ url('themes/inspinia/css/style.css') }}">
            ...
            <div class="col-12">
                ...
                <div class="float-right">
                    @if(session()->get('locale')=='ms')
                        <a href="{{route('locale.l10n','en')}}" style="background:none;color:#fff;">
                            <small>English</small>
                            {{-- <img src="https://eaduan.kpdnhep.gov.my/img/United-Kingdom.png" width="20px"> --}}
                            <img src="{{ asset('img/United-Kingdom.png') }}" width="20px">
                        </a>
                    @else
                        <a href="{{route('locale.l10n','ms')}}" style="background:none;color:#fff;">
                            <small>Bahasa Malaysia</small>
                            {{-- <img src="https://eaduan.kpdnhep.gov.my/img/Malaysia.png" width="20px"> --}}
                            <img src="{{ asset('img/Malaysia.png') }}" width="20px">
                        </a>
                    @endif
