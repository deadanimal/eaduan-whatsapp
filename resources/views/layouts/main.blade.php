...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('DataTables/css/dataTables.dataTables.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('DataTables/css/dataTables.dataTables.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('DataTables/css/dataTables.foundation.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('DataTables/css/dataTables.foundation.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('DataTables/css/dataTables.jqueryui.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('DataTables/css/dataTables.jqueryui.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('DataTables/css/dataTables.semanticui.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('DataTables/cssdataTables.semanticui.min.css')}}">
