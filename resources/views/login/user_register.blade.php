            ...
            <div class="col">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/user-submit') }}">
                    ...
                    <div class="form-group{{ $errors->has('citizen') ? ' has-error' : '' }}">
                        <label for="citizen" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_resident_sts')
                        </label>
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('citizen'))
                                <span class="help-block" style="color: #ed5565;">
                    ...
                    <div class="form-group{{ $errors->has('passport') ? ' has-error' : '' }}" id="div_passport">
                        <label style="display: {{ (old('citizen') != ''? (old('citizen') == '0'? 'block':'none'):'block') }};"
                               for="passport"
                               class="col-md-4 control-label required">
                            @lang('auth.register.lbl_passport')
                        </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <label for="name" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_name')
                        </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        <label for="email" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_email')
                        </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group{{ $errors->has('mobile_no') ? ' has-error' : '' }}">
                        <label for="mobile_no" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_mobile_no')
                        </label>
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('mobile_no'))
                                <span class="help-block" style="color: #ed5565;"><strong>{{ $errors->first('mobile_no') }}</strong></span>
                            @endif
                        </div>
                    </div>
                    <div id='gender' style="display: {{ old('citizen') == '0'? 'block':'none' }}"
                         class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                        <label for="gender" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_gender')
                        </label>
                        <div class="col-md-6">
                            {{ Form::select('gender', \App\Ref::GetList('202', true, app()->getLocale() != ''? app()->getLocale():'en'), null, ['class' => 'form-control input-sm']) }}
                            @if ($errors->has('gender'))
                                <span class="help-block" style="color: #ed5565;"><strong>{{ $errors->first('gender') }}</strong></span>
                            @endif
                        </div>
                    </div>
                    <div id='age' style="display: {{ old('citizen') == '0'? 'block':'none' }}"
                         class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                        <label for="age" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_age')
                        </label>
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('age'))
                                <span class="help-block" style="color: #ed5565;"><strong>{{ $errors->first('age') }}</strong></span>
                            @endif
                        </div>
                    </div>
                    <div id='address' style="display: {{ old('citizen') == '0'? 'block':'none' }}"
                         class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                        <label for="address" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_address_in_mys')
                        </label>
                        <div class="col-md-6">
                            {{ Form::textarea('address', '', ['class' => 'form-control input-sm', 'rows'=>'4']) }}
                            @if ($errors->has('address'))
                                <span class="help-block" style="color: #ed5565;"><strong>{{ $errors->first('address') }}</strong></span>
                            @endif
                        </div>
                    </div>
                    <div id='postcode' style="display: {{ old('citizen') == '0'? 'block':'none' }}"
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('postcode'))
                                <span class="help-block" style="color: #ed5565;"><strong>{{ $errors->first('postcode') }}</strong></span>
                            @endif
                        </div>
                    </div>
                    <div id='state' style="display: {{ old('citizen') == '0'? 'block':'none' }}"
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('state_cd'))
                                <span class="help-block" style="color: #ed5565;"><strong>{{ $errors->first('state_cd') }}</strong></span>
                            @endif
                        </div>
                    </div>
                    <div id='district_cd' style="display: {{ old('citizen') == '0'? 'block':'none' }}"
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('distrinct_cd'))
                                <span class="help-block" style="color: #ed5565;"><strong>{{ $errors->first('distrinct_cd') }}</strong></span>
                            @endif
                        </div>
                    </div>
                    <div id='ctry_cd' style="display: {{ old('citizen') == '0'? 'block':'none' }}"
                         class="form-group{{ $errors->has('ctry_cd') ? ' has-error' : '' }}">
                        <label for="ctry_cd" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_ctry')
                        </label>
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('ctry_cd'))
                                <span class="help-block" style="color: #ed5565;"><strong>{{ $errors->first('ctry_cd') }}</strong></span>
                            @endif
                        </div>
                    </div>
                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        <label for="password" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_password')
                        </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                        <label for="password-confirm" class="col-md-4 control-label required">
                            @lang('auth.register.lbl_confirm_password')
                        </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group{{ $errors->has('captcha') ? ' has-error' : '' }}">
                        <div class="col-md-6 col-md-offset-4">
                            <p>
                                <img width="50%" class="img-thumbnail" id="captcha" src="{{ Captcha::src('flat') }}">
                                &nbsp
                            ...
                            <p>
                                <input type="text" class="form-control input-sm" style="width: 40%;" name="captcha">
                            </p>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-4">
                            <a href="{{ url('kepenggunaan')}}" type="button" class="btn btn-primary btn-sm">
                                @lang('button.back')
                            </a>
                            &nbsp;
