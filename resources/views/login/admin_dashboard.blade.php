    ...
    <div class="col-lg-12">
        <div class="tabs-container">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a data-toggle="tab" href="#tab-consumercomplaint">Aduan Kepenggunaan</a>
                </li>
                <li class="">
                    <a data-toggle="tab" href="#tab-enquiry">Pertanyaan / Cadangan</a>
                </li>
                <li class="">
                    <a data-toggle="tab" href="#tab-integrity">Aduan Integriti</a>
                </li>
                <li class="">
                    <a data-toggle="tab" href="#tab-ep">Fail Kes (EP)</a>
                </li>
            </ul>
            <div class="tab-content">
                <div id="tab-consumercomplaint" class="tab-pane active">
                        ...
                        @if(!in_array(Auth::user()->role->role_code,['191', '192', '193']))
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <a href="{{ url('tugas') }}">
                                        <div class="widget style1 blue-bg" style="min-height: 110px;">
                                            <div class="row">
                                                <div class="col-xs-2">
                ...
                <div id="tab-enquiry" class="tab-pane">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <a href="{{ url('integrititugas') }}">
                                        <div class="widget style1 blue-bg" style="min-height: 140px;">
                                            <div class="row">
                                                <div class="col-xs-2">
