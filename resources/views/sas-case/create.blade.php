...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <h2>Tambah Aduan Profil Tinggi</h2>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div id="div_CA_ONLINECMPL_BANKCD" style="display: {{ old('CA_CMPLCAT') == 'BPGK 19'? 'block':'none' }};" class="form-group{{ $errors->has('CA_ONLINECMPL_BANKCD') ? ' has-error' : '' }}">
                            <label for="CA_ONLINECMPL_BANKCD" class="col-sm-5 control-label {{ in_array(old('CA_ONLINECMPL_PYMNTTYP'),['','COD']) ? '':'required' }}">Nama Bank</label>
                        ...
                        <div id="div_CA_ONLINECMPL_ACCNO" style="display: {{ old('CA_CMPLCAT') == 'BPGK 19'? 'block':'none' }};" class="form-group{{ $errors->has('CA_ONLINECMPL_ACCNO') ? ' has-error' : '' }}">
                            <label for="CA_ONLINECMPL_ACCNO" class="col-sm-5 control-label {{ in_array(old('CA_ONLINECMPL_PYMNTTYP'),['','COD']) ? '':'required' }}">No. Akaun Bank</label>
