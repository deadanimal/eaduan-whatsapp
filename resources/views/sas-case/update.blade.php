...
<h2>Kemaskini Aduan Profil Tinggi</h2>
<div class="row">
    <!--<div class="col-lg-6">-->
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('CA_RCVDT') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-7">
                                        {{ Form::text('CA_RCVDT', Carbon::parse($mSasCase->CA_RCVDT)->format('d-m-Y'), ['class' => 'form-control input-sm', 'readonly' => true]) }}
                                ...
                                <div class="form-group{{ $errors->has('CA_COMPLETEDT') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        {{ Form::text('CA_COMPLETEDT', $mSasCase->CA_COMPLETEDT != '' ? Carbon::parse($mSasCase->CA_COMPLETEDT)->format('d-m-Y') : '', ['class' => 'form-control input-sm', 'readonly' => true]) }}
...
<!--                                <div class="form-group{{ $errors->has('CA_ONLINECMPL_AMOUNT') ? ' has-error' : '' }}">
                                ...
                                <div id="div_CA_ONLINECMPL_BANKCD" style="display: {{ (old('CA_CMPLCAT')? (old('CA_CMPLCAT') == 'BPGK 19'? 'block':'none') : ($mSasCase->CA_CMPLCAT == 'BPGK 19'? 'block':'none')) }};" class="form-group{{ $errors->has('CA_ONLINECMPL_BANKCD') ? ' has-error' : '' }}">
                                    <label for="CA_ONLINECMPL_BANKCD" class="col-sm-5 control-label {{ old('CA_ONLINECMPL_PYMNTTYP') ? (in_array(old('CA_ONLINECMPL_PYMNTTYP'),['','COD']) ? '':'required') : (in_array($mSasCase->CA_ONLINECMPL_PYMNTTYP,['','COD']) ? '' : 'required') }}">Nama Bank</label>
                                    <div class="col-sm-7">
                                ...
                                <div id="div_CA_ONLINECMPL_ACCNO" style="display: {{ (old('CA_CMPLCAT')? (old('CA_CMPLCAT') == 'BPGK 19'? 'block':'none') : ($mSasCase->CA_CMPLCAT == 'BPGK 19'? 'block':'none')) }};" class="form-group{{ $errors->has('CA_ONLINECMPL_ACCNO') ? ' has-error' : '' }}">
                                    <label for="CA_ONLINECMPL_ACCNO" class="col-sm-5 control-label {{ old('CA_ONLINECMPL_PYMNTTYP') ? (in_array(old('CA_ONLINECMPL_PYMNTTYP'),['','COD']) ? '':'required') : (in_array($mSasCase->CA_ONLINECMPL_PYMNTTYP,['','COD']) ? '' : 'required') }}">No. Akaun Bank</label>
