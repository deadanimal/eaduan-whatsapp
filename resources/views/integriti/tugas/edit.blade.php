            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="{{ route('integrititugas.index') }}">
...
<div class="row">
    ...
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab-penugasan"> Penugasan</a></li>
            <li class=""><a data-toggle="tab" href="#tab-email"> Pernyataan E-mel</a></li>
        ...
        <div class="tab-content">
            <div id="tab-penugasan" class="tab-pane active">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <!-- {{-- Form::text('IN_ASGBY', $user->name, ['class' => 'form-control input-sm','readonly' => true]) --}} -->
            ...
            <div id="tab-email" class="tab-pane">
                <div class="panel-body">
                    <div class="row">
                        {{ Form::open(['route' => 'integrititugas.emailconsumercomplaint.store']) }}
                        <div class="col-lg-2"></div>
                        <div class="col-lg-8">
                            <div class="alert alert-danger">
                                <p style="font-weight:bold; font-size:1.5rem">
                                    Cara masukkan email yang banyak pada medan 'Kepada', 'Cc' & 'Bcc' adalah dengan menggunakan 
                                    simbol ';' untuk memisahkan antara emel-emel yang ingin dihantar. 
                                    Sebagai contoh: abc@gmail.com;def@yahoo.com
                                </p>
                            </div>
                            @includeIf('integriti.tugas.email_fields')
                            <div class="row">
                                <!-- Submit Field -->
                                <div class="form-group col-sm-12 m-b-none text-center">
                                    <a href="{{ route('integrititugas.index') }}" class="btn btn-default">Kembali</a>
                                    {{ Form::submit('Hantar E-mel', ['class' => 'btn btn-primary']) }}
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2"></div>
...
@includeIf('integriti.tugas.usersearchmodal')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <!-- <div class="form-group"> -->
                            ...
                            <!-- <div class="col-sm-9"> -->
                                <!-- {{-- Form::text('state_cd', Ref::GetDescr('17', $user->state_cd), ['class' => 'form-control input-sm', 'readonly' => true]) --}} -->
                            <!-- </div> -->
                        <!-- </div> -->
                        <!-- <div class="form-group{{ $errors->has('brn_cd') ? ' has-error' : '' }}"> -->
                            <!-- {{-- Form::label('brn_cd', 'Cawangan', ['class' => 'col-sm-3 control-label']) --}} -->
                            <!-- <div class="col-sm-9"> -->
                                <!-- {{-- Form::text('brn_cd', Branch::GetBranchName($user->brn_cd), ['class' => 'form-control input-sm', 'readonly' => true]) --}} -->
                            <!-- </div> -->
                        <!-- </div> -->
