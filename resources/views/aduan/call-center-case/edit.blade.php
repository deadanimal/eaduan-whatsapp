                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div id="div_CA_ONLINECMPL_BANKCD" style="display: {{ (old('CA_CMPLCAT')? (old('CA_CMPLCAT') == 'BPGK 19'? 'block':'none') : ($mCallCase->CA_CMPLCAT == 'BPGK 19'? 'block':'none')) }};" class="form-group{{ $errors->has('CA_ONLINECMPL_BANKCD') ? ' has-error' : '' }}">
                                ...
                                <label for="CA_ONLINECMPL_BANKCD" class="col-sm-4 control-label {{ old('CA_ONLINECMPL_PYMNTTYP') ? (in_array(old('CA_ONLINECMPL_PYMNTTYP'),['','COD']) ? '':'required') : (in_array($mCallCase->CA_ONLINECMPL_PYMNTTYP,['','COD']) ? '' : 'required') }}">Nama Bank</label>
                                <div class="col-sm-8">
                            ...
                            <div id="div_CA_ONLINECMPL_ACCNO" style="display: {{ (old('CA_CMPLCAT')? (old('CA_CMPLCAT') == 'BPGK 19'? 'block':'none') : ($mCallCase->CA_CMPLCAT == 'BPGK 19'? 'block':'none')) }};" class="form-group{{ $errors->has('CA_ONLINECMPL_ACCNO') ? ' has-error' : '' }}">
                                ...
                                <label for="CA_ONLINECMPL_ACCNO" class="col-sm-4 control-label {{ old('CA_ONLINECMPL_PYMNTTYP') ? (in_array(old('CA_ONLINECMPL_PYMNTTYP'),['','COD']) ? '':'required') : (in_array($mCallCase->CA_ONLINECMPL_PYMNTTYP,['','COD']) ? '' : 'required') }}">No. Akaun Bank / No. Transaksi FPX</label>
                                <div class="col-sm-8">
                                    {{ Form::text('CA_ONLINECMPL_ACCNO', $mCallCase->CA_ONLINECMPL_ACCNO, ['class' => 'form-control input-sm','onkeypress' => "return isNumberKey(event)"]) }}
...
<!--                            <div class="form-group {{ $errors->has('CA_ROUTETOHQIND') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group{{ $errors->has('CA_SUMMARY') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::textarea('CA_SUMMARY', $mCallCase->CA_SUMMARY, ['class' => 'form-control input-sm','rows'=>'4']) }}
