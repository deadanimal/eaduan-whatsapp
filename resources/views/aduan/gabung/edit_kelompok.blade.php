                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <p class="form-control-static">{{ $countCurrentDuration[$CASEID] ?? 0 }}</p>
                                <input type="hidden" name="CD_REASON_DURATION['{{ $CASEID }}']" id="CD_REASON_DURATION['{{ $CASEID }}']" value="{{ $countCurrentDuration[$CASEID] ?? 0 }}" class="form-control" readonly>
                            </div>
                        </div>
                        {{-- @if ($countDuration[$CASEID] >= 4) --}}
                        @if(($countCurrentDuration[$CASEID]) && ($countCurrentDuration[$CASEID] >= 4))
                        <div class="col-md-4">
