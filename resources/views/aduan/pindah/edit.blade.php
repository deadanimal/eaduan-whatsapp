                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div id="countCurrentDuration"
                                class="form-group"
                                style="display: {{ old('CA_INVSTS') != '' ? 'block' : 'none' }} ;">
                                {{ Form::label('', 'Tempoh Seliaan', ['class' => 'col-lg-4 control-label']) }}
                                <div class="col-lg-8">
                                    <p class="form-control-static">
                                        {{-- $countDuration --}}
                                        {{ $mPindah->countCurrentDuration ?? 0 }}
                                    </p>
                                    {{-- Form::hidden('CD_REASON_DURATION', $countDuration, ['class' => 'form-control input-sm', 'readonly' => true]) --}}
                                    {{ Form::hidden('CD_REASON_DURATION', $mPindah->countCurrentDuration ?? 0, ['class' => 'form-control input-sm', 'readonly' => true]) }}
                                </div>
                            </div>
                            {{-- @if ($countDuration >= 4) --}}
                            @if(($mPindah->countCurrentDuration) && ($mPindah->countCurrentDuration >= 4))
                            <div id="cd_reason"
