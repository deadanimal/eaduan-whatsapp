                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div id="div_CA_ONLINECMPL_BANKCD" style="display: {{ (old('CA_CMPLCAT')? (old('CA_CMPLCAT') == 'BPGK 19'? 'block':'none') : ($model->CA_CMPLCAT == 'BPGK 19'? 'block':'none')) }};" class="form-group{{ $errors->has('CA_ONLINECMPL_BANKCD') ? ' has-error' : '' }}">
                            ...
                            <label for="CA_ONLINECMPL_BANKCD" class="col-sm-5 control-label {{ old('CA_ONLINECMPL_PYMNTTYP') ? (in_array(old('CA_ONLINECMPL_PYMNTTYP'),['','COD','TB']) ? '':'required') : (in_array($model->CA_ONLINECMPL_PYMNTTYP,['','COD','TB']) ? '' : 'required') }}">Nama Bank</label>
                        ...
                        <div id="div_CA_ONLINECMPL_ACCNO" style="display: {{ (old('CA_CMPLCAT')? (old('CA_CMPLCAT') == 'BPGK 19'? 'block':'none') : ($model->CA_CMPLCAT == 'BPGK 19'? 'block':'none')) }};" class="form-group{{ $errors->has('CA_ONLINECMPL_ACCNO') ? ' has-error' : '' }}">
                            ...
                            <label for="CA_ONLINECMPL_ACCNO" class="col-sm-5 control-label {{ old('CA_ONLINECMPL_PYMNTTYP') ? (in_array(old('CA_ONLINECMPL_PYMNTTYP'),['','COD','TB']) ? '':'required') : (in_array($model->CA_ONLINECMPL_PYMNTTYP,['','COD','TB']) ? '' : 'required') }}">No. Akaun Bank / No. Transaksi FPX</label>
                        ...
                        <div class="form-group"
                            ...
                            <div class="col-sm-7">
                                <div class="checkbox checkbox-success">
                                    <input name="CA_ONLINECMPL_IND" id="CA_ONLINECMPL_IND" type="checkbox" onclick="onlinecmplind()" {{ old('CA_ONLINECMPL_IND') == 'on'? 'checked':'' || $model->CA_ONLINECMPL_IND == '1'? 'checked':'' }} value="1">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div id="checkinsertadd"
                            ...
                            <div class="col-sm-7">
                                <div class="checkbox checkbox-success">
                                    <input name="CA_ONLINEADD_IND" id="CA_ONLINEADD_IND" type="checkbox" onclick="onlineaddind()" {{ old('CA_ONLINEADD_IND') == 'on'? 'checked':'' || $model->CA_ONLINEADD_IND == '1'? 'checked':'' }} value="1">
