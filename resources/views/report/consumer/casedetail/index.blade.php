                ...
                <div class="ibox-content">
                    @if(isset($data['issearch']) && $data['issearch'])
                        <div class="table-responsive">
                            ...
                            <h4 class="text-center">{{ $data['branchtext'] ?? '' }}</h4>
                            <h4 class="text-center">{{ $data['casetext'] ?? '' }}</h4>
                        </div>
                        <hr class="hr-line-solid">
                        <div class="table-responsive">
                            @includeIf('report.consumer.casedetail.table')
                        </div>
                    @endif
                </div>
            </div>
        ...
        $(function() {
            $('#casedetailtable').DataTable({
                ...
                dom: '<\'row\'<\'col-sm-6\'i><\'col-sm-6 Bfrtip html5buttons\'B<\'pull-right\'l>>>' +
                    ...
                    '<\'row\'<\'col-sm-12\'p>>',
                ajax: {
                    url: "{{ url('report/consumer/casedetail/dt') }}" 
