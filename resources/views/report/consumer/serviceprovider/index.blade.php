            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 col-lg-8">
                                <div class="table-responsive">
                                    ...
                                    {{-- <div class="form-group"> --}}
                                        {{-- <div class="input-group"> --}}
                                            {{-- Form::label('option', 'Pilihan Paparan:', ['class' => 'control-label']) --}}
                                            {{-- Form::select('option', $data['options'] ?? [], null, ['class' => 'form-control']) --}}
                                        {{-- </div> --}}
                                    {{-- </div> --}}
                    ...
                    @if(isset($data['issearch']) && $data['issearch'])
                        ...
                        <div class="table-responsive">
                            @includeIf('report.consumer.serviceprovider.table_link')
                        </div>
                    @endif
                </div>
            </div>
