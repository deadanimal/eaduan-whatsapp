                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                {{ Form::select('pegawai', $investigatorList, old('pegawai'), ['class' => 'form-control input-sm select2', 'id' => 'pegawai', 'placeholder' => 'SEMUA']) }}
                            </div>
                        </div>

                        <div class="form-group" align="center">
                            {{-- link_to('laporanlainlain/laporan_pegawai', 'Semula', ['class' => 'btn btn-default btn-sm']) --}}
                            <a class="btn btn-default btn-sm" href="{{ url('laporanlainlain/laporan_pegawai') }}">
                                <i class="fa fa-refresh"></i>&nbsp;Semula
                            </a>
                            {{-- Form::submit('Jana', ['class' => 'btn btn-primary btn-sm', 'name'=>'gen', 'value'=>'search']) --}}
                            {{ Form::button('<i class="fa fa-search"></i>&nbsp;Jana', ['type' => 'submit', 'class' => 'btn btn-primary btn-sm']) }}
                        </div>
                        @if($search)
                            <div class="col-sm-12">
                                <div class="form-group" align="center">
                        ...
                        <table id="state-table"
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 15%;">Jumlah Aduan</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php
