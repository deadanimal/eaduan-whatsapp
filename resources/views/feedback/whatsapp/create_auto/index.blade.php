        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <div class="panel-body">
                    {!! Form::open(['route' => 'whatsapp.storeauto', 'class' => 'form-horizontal']) !!}
                    {{ csrf_field() }}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group{{ $errors->has('CA_RCVTYP') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select disabled>
                                      <option selected value="S37">Whatsapp</option>
                                    </select>
                                    <input type="hidden" name="CA_RCVTYP" value="S37">
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="col-sm-6" style="margin-left:50px;">
                              ...
                              <div class="h5" style="font-weight: bold; margin-bottom: 0px;">Info {{$key+1}}: </div>
                                <?php 
                                echo nl2br($info);
                                ?>
                                <br><br>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group{{ $errors->has('CA_DOCNO') ? ' has-error' : '' }}">
                                ...
                                <input class="form-control input-sm" type="text" name="CA_DOCNO" value="{{$ic}}" id="CA_DOCNO">
                                <!--<span class="input-group-btn">-->
                                    <!--<button class="btn btn-primary btn-sm" type="button" id="CheckJpn">Semak JPN</button>-->
                            ...
                            <div class="form-group{{ $errors->has('CA_EMAIL') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control input-sm" value="{{$email}}" name="CA_EMAIL" id="CA_EMAIL">
                            ...
                            <div class="form-group{{ $errors->has('CA_MOBILENO') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control input-sm" name="CA_MOBILENO" id="CA_MOBILENO" value="{{$telefon}}">
                            ...
                            <div class="form-group{{ $errors->has('CA_ADDR') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea name="CA_ADDR" class="form-control input-sm" id="CA_ADDR" rows="4">{{$alamat}}</textarea>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group{{ $errors->has('CA_NAME') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" class="form-control input-sm" id="CA_NAME" name="CA_NAME" value="{{$nama}}">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group"
                                ...
                                <div class="col-sm-7">
                                    <div class="checkbox checkbox-success">
                                        <input name="CA_ONLINECMPL_IND" id="CA_ONLINECMPL_IND" type="checkbox" onclick="onlinecmplind()" {{ old('CA_ONLINECMPL_IND') == 'on'? 'checked':'' }} value="1">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group{{ $errors->has('CA_AGAINSTNM') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input type="text" class="form-control input-sm" id="CA_AGAINSTNM" name="CA_AGAINSTNM" value="{{$namaprem}}">
                            ...
                            <div id="checkinsertadd"
                                ...
                                <div class="col-sm-7">
                                    <div class="checkbox checkbox-success">
                                        <input name="CA_ONLINEADD_IND" id="CA_ONLINEADD_IND" type="checkbox" onclick="onlineaddind()" {{ old('CA_ONLINEADD_IND') == 'on'? 'checked':'' }} value="1">
                            ...
                            <!--<label for="CA_AGAINSTADD" class="col-sm-5 control-label {{ old('CA_CMPLCAT') == 'BPGK 19'? '':'required' }}">Alamat</label>-->
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <textarea name="CA_AGAINSTADD" class="form-control input-sm" id="CA_AGAINSTADD" rows="4">{{$alprem}}</textarea>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group{{ $errors->has('CA_SUMMARY') ? ' has-error' : '' }}">
                                ...
                                <textarea name="CA_SUMMARY" id="CA_SUMMARY" class="form-control input-sm" rows="4">{{$keteranganaduan}}</textarea>
                    ...
                    <input type="hidden" name="checktest" value="{{$media_and_created_at}}">
