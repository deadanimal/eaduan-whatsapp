                        ...
                        <div class="col-sm-8 col-xs-6">
							...
							@if($jenis_user != '999')
                                <div class="col-sm-4">
                                    ...
                                    <ul>
										<li>
											<a class="nav-link text-center" href="{{route('whatsapp.semuaa')}}">Semua</a>
                                        </li>
                                        <li>
											<a class="nav-link text-center" href="{{route('whatsapp.aktifke')}}">Aktif</a>
                                        </li>
                                        <li>
											<a class="nav-link text-center" href="{{route('whatsapp.tugasansaya')}}">My Task</a>
										</li>
                                    </ul>
                                    <ul>
                                        <li>
							...
							@if($jenis_user == '800')
								<div class="col-sm-4">
                                    ...
                                    <ul>
                                        <li><a class="nav-link text-center"
                                               href="{{route('whatsapp.newhelpdesk')}}">Laporan Helpdesk</a>
                                        </li>
                                        <li><a class="nav-link text-center"
                                               href="{{route('whatsapp.newdokumenfasa')}}">Simpanan Dokumen</a>
                                        </li>
                                    </ul>
                                </div>
							@elseif($jenis_user == '999')
								<div class="col-sm-4">
                                    <h4>Pentadbiran</h4>
                                    <ul>
                                        <li><a class="nav-link text-center"
