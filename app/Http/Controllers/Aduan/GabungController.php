...
//        dd($Request);
        ...
        foreach($arrCASEID as $caseid) {
            ...
            if($countCurrentDuration[$caseid] >= 4){
        ...
        if($Request->submit == 1) {
            ...
            return view('aduan.gabung.edit', compact('arrCASEID','mUser','caseReasonTemplates','countDuration','countDurationIndicator','countCurrentDuration'));
        }
        
        if($Request->submit == 2) {
            $arrCASEID = $Request->CASEID;
            $mUser = User::find(Auth::User()->id);
            return view('aduan.gabung.edit_kelompok', compact('arrCASEID','mUser','caseReasonTemplates','countDuration','countDurationIndicator','countCurrentDuration'));
        }
