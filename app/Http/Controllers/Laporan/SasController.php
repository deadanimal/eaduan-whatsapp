...
class SasController extends Controller
{
    ...
    public function CaraPenerimaan(Request $Request)
    {
        ...
        $titleyear = 'LAPORAN CARA PENERIMAAN ADUAN KHAS';
        $datachart1 = '';
        $datachart2 = '';
...
//                    COUNT(sys_ref.code) AS Bilangan,
            ...
            if($Request->has('year')) {
                ...
                $titleyear = 'LAPORAN CARA PENERIMAAN ADUAN KHAS BAGI TAHUN '.$Request->get('year');
