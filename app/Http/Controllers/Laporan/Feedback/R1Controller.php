...
class R1Controller extends Controller
{
            ...
            switch ($gen) {
                case 'p':
                    $this->generatePdf($title, $year, $data_final, $data_final_total, $data_final_pct
                        , $data_final_case_info, $template_by_title, $category_name, $gen);
                    break;
                case 'e':
     ...
     */
    public function generatePdf($title, $year, $data_final, $data_final_total, $data_final_pct, $data_final_case_info, $template_by_title, $category_name, $gen)
    {
     ...
     * @return mixed
     */
    public function generateExcel($type, $title, $year, $data_final, $data_final_total, $data_final_pct, $data_final_case_info, $template_by_title, $category_name, $gen)
    {
        
        return Excel::create($title . date("_Ymd_His"), function ($excel) use ( $title, $year, $data_final, $data_final_total, $data_final_pct, $data_final_case_info, $template_by_title, $category_name, $gen) {
            $excel->sheet('Report', function ($sheet) use ($title, $year, $data_final, $data_final_total, $data_final_pct, $data_final_case_info, $template_by_title, $category_name, $gen) {
