...
//            $q = DB::table('case_info')
    ...
    public function laporanpegawai(Request $request)
    {
        ...
        $investigatorList = UserRepository::getList($user_cat = '1', $status = '1', $state, $branch, $isLimitByState, $isLimitByBranch);
        ...
        switch ($generate) {
            ...
            default:
                return view('laporan.laporanlainlain.laporan_pegawai.index',
                    compact('user', 'role', 'dateStart', 'dateEnd', 'stateList', 'search', 'isLimitByBranch', 'isLimitByState', 'branchList', 'state', 'branch', 'dataFinal', 'branchName', 'investigatorList'));
                break;
        }
    }
