    ...
    public function index()
    {
        ...
        if(in_array(Auth::user()->Role->role_code,['110','120','125','160','194','220','225','800'])) {
            $collections['reportOthers'] = [
                ...
                'list' => [
                    ...
                    ['title' => 'Laporan Aduan Menghasilkan Kes Mengikut Negeri & Cawangan (2)', 'url' => 'report/consumer/case'],
        ...
        if(in_array(Auth::user()->Role->role_code,['125','160','225','800'])) {
            $collections['reportSas'] = [
                'key' => 'reportSas',
                // 'name' => 'Laporan SAS',
                'name' => 'Laporan Aduan Khas',
                'list' => [
                    // ['title' => 'Laporan Cara Penerimaan SAS', 'url' => 'sas-report/cara-penerimaan'],
                    ['title' => 'Laporan Cara Penerimaan Aduan Khas', 'url' => 'sas-report/cara-penerimaan'],
        ...
        if(in_array(Auth::user()->Role->role_code,['110','120','125','160','180','194','800'])) {
            $collections['reportEnquiry'] = [
                ...
                'list' => [
                    ...
                    ['title' => 'Laporan Pertanyaan / Cadangan Mengikut Kategori', 'url' => 'report/askenquiry/category'],
                ]
            ];
        }
        if(in_array(Auth::user()->Role->role_code,['110','120','125','160','194','800'])) {
        ...
        if(in_array(Auth::user()->Role->role_code,['120','125','800'])) {
            $collections['reportIsoByMonth'] = [
                ...
                'list' => [
                    ...
                    ['title' => 'Laporan Aduan Mengikut Tempoh, Negeri & Bahagian', 'url' => 'laporanisobulanan/aduanallikutnegeribahagianpercent'],
                ]
            ];
            $collections['reportIsoCumulative'] = [
                ...
                'list' => [
                    ...
                    ['title' => 'Laporan Aduan Mengikut Tempoh, Negeri & Bahagian', 'url' => 'laporanisokumulatif/aduanallikutnegeribahagianpercent'],
                ]
            ];
