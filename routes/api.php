...
use App\Http\Controllers\Feedback\Whatsapp\NewController;
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
...
Route::group(['middleware' => 'auth:api'], function() {
    ...
    // Templat Alasan
    Route::get('casereasontemplates', 'Api\CaseReasonTemplateController@index');
});
...
// API NAJHAN
Route::any('api_najhan/{id}', 'Api\StateDistrictController@getByAduanNo');
...
// Route::any('myidentity/{ic}', 'Api\MyIdentityController');
