...
Route::get('integriti', 'PortalIntegrityController')->name('integriti');
...
Route::any('/authenticate','Auth\GluuloginController@gluulogin');
Route::get('/gluulogout','Auth\GluuloginController@gluulogout');
...
Route::resource('ref/integrity/categories', 'Ref\Integrity\RefIntegrityCategoryController', ['only' => ['index', 'create', 'store', 'show', 'edit', 'update'], 'as' => 'ref.integrity']);
...
Route::resource('publiccaserating', 'Aduan\PublicCaseRatingController', ['only' => ['index', 'create', 'store']]);
...
Route::get('admin-case/tojpn/{ic?}', 'Admin\MyIdentityController');
...
Route::group(['namespace' => 'Pertanyaan'], function () {
    ...
    Route::resource('inquiry/consumercomplaints', 'ConsumerComplaintController', ['only' => ['index', 'show'], 'as' => 'inquiry']);
});
...
Route::group(['prefix' => 'report', 'namespace' => 'Report', 'middleware' => 'auth'], function () {
    Route::get('consumer/case', 'Consumer\ReportConsumerCaseController@index')->name('report.consumer.case.index');
    Route::get('consumer/casedetail/dt', 'Consumer\ReportConsumerCaseDetailController@dt')->name('report.consumer.casedetail.dt');
    Route::get('consumer/casedetail', 'Consumer\ReportConsumerCaseDetailController@index')->name('report.consumer.casedetail.index');
    Route::get('consumer/serviceprovider', 'Consumer\ReportConsumerServiceProviderController@index')->name('report.consumer.serviceprovider.index');
    Route::get('ad52/report2detail', 'Ad52\Report2DetailController@index')->name('report.ad52.report2detail.index');
    Route::get('ad52/report2detail/dt', 'Ad52\Report2DetailController@dt')->name('report.ad52.report2detail.dt');
    Route::group(['prefix' => 'integrity', 'namespace' => 'Integrity'], function () {
        Route::get('status/detail', 'ReportIntegrityStatusDetailController@index')->name('report.integrity.statusdetail.index');
    });
    Route::group(['prefix' => 'askenquiry', 'namespace' => 'AskEnquiry'], function () {
        Route::get('category', 'ReportAskEnquiryCategoryController@index')->name('report.askenquiry.category.index');
    });
});
...
Route::resource('integrititugas/emailconsumercomplaint', 'Integriti\IntegritiTugasEmailConsumerComplaintController', ['only' => ['index', 'store'], 'as' => 'integrititugas']);
Route::resource('integrititugas', 'Integriti\IntegritiTugasController', ['only' => ['index', 'show', 'edit', 'update']]);
...
Route::group(['namespace' => 'Feedback', 'prefix' => 'feedback'], function () {
    ...
    Route::group(['namespace' => 'Whatsapp', 'prefix' => '', 'name' => 'whatsapp'], function () {
		...
		Route::get('whatsapp/tugasansaya', 'NewController@tugasansaya')->name('whatsapp.tugasansaya');
        Route::post('whatsapp/caritugasan', 'NewController@caritugasan')->name('whatsapp.caritugasan');

        Route::get('whatsapp/paparsemua/{mesej}', 'NewController@paparsemua')->name('whatsapp.paparsemua');

        Route::post('whatsapp/storeauto', 'NewController@storeauto')->name('whatsapp.storeauto');
        Route::any('whatsapp/autoattach/{id}/{mesej_id}', 'NewController@autoattach')->name('whatsapp.autoattach');
        Route::any('whatsapp/deleteattach/{id}/{mesej_id}', 'NewController@deleteattach')->name('whatsapp.deleteattach');
        Route::get('whatsapp/getdatatablews/{CASEID}/{mesej_id}', 'NewController@getdatatable');
        Route::get('whatsapp/preview_aduanws/{id}/{mesej_id}', 'NewController@preview')->name('whatsapp.preview_aduanws');
        Route::patch('whatsapp/submit_aduanws/{id}', 'NewController@submit')->name('whatsapp.submit_aduanws');
		
		Route::get('whatsapp/aktifke', 'NewController@aktifke')->name('whatsapp.aktifke');
        Route::post('whatsapp/cariaktif', 'NewController@cariaktif')->name('whatsapp.cariaktif');
		Route::get('whatsapp/hantaraktif/{room_id}', 'NewController@paparaktifke')->name('whatsapp.paparaktifke');
		Route::post('whatsapp/room/{room}/buang_tugas', 'NewController@buang_tugas')->name('whatsapp.buang_tugas');
		Route::post('whatsapp/room/{room}/tambah_tugas', 'NewController@tambah_tugas')->name('whatsapp.tambah_tugas');
		
		Route::get('whatsapp/papar/{mesej}', 'NewController@paparmesej')->name('whatsapp.paparmesej');
		Route::post('whatsapp/hantarmesej/{mesej}', 'NewController@hantarmesej')->name('whatsapp.hantarmesej');
		Route::get('whatsapp/potong/{id}/{index}', 'NewController@potong')->name('whatsapp.potong');
        Route::get('whatsapp/potong2/{id}/{index}', 'NewController@potong2')->name('whatsapp.potong2');
		Route::get('whatsapp/room/{room_id}/aktif', 'NewController@aktif_bot')->name('whatsapp.aktif_bot');
        Route::post('whatsapp/room/{room}/selesai_mesej', 'NewController@selesai_mesej')->name('whatsapp.selesai_mesej');
		
		Route::post('whatsapp/cari_tugasan', 'NewController@cari_tugasan')->name('whatsapp.cari_tugasan');
		Route::post('whatsapp/room/{room}/officer', 'NewController@add_officer')->name('whatsapp.add_officer');
		Route::post('whatsapp/room/{room}/buang_officer', 'NewController@buang_officer')->name('whatsapp.buang_officer');
		
		Route::get('whatsapp/laporanbulanan', 'NewController@laporanbulanan')->name('whatsapp.laporanbulanan');
		Route::post('whatsapp/caribulanan', 'NewController@caribulanan')->name('whatsapp.caribulanan');
		Route::get('whatsapp/laporanbulanan/2020', 'NewController@bulanan2020')->name('whatsapp.bulanan2020');
		
		Route::get('whatsapp/newhelpdesk', 'NewController@newhelpdesk')->name('whatsapp.newhelpdesk');
		Route::post('whatsapp/newstorehelpdesk', 'NewController@newstorehelpdesk')->name('whatsapp.newstorehelpdesk');
		Route::post('whatsapp/update_keterangan/{$id}', 'NewController@update_keterangan')->name('whatsapp.update_keterangan');

		
		Route::get('whatsapp/newdokumenfasa', 'NewController@newdokumenfasa')->name('whatsapp.newdokumenfasa');
		Route::post('whatsapp/storedokumen', 'NewController@storedokumen')->name('whatsapp.storedokumen');
		
		//Route::get('whatsapp/papar/{$id}', 'NewController@paparaktifke')->name('whatsapp.aktifke');
		Route::get('whatsapp/semuaa', 'NewController@semuaa')->name('whatsapp.semuaa');
        Route::post('whatsapp/carisemuaa', 'NewController@carisemuaa')->name('whatsapp.carisemuaa');
        Route::get('whatsapp/room/{$id}/aktif', 'NewController@bot_aktif')->name('whatsapp.bot_aktif');
        ...
        Route::any('whatsapp/api_najhan/{req}', 'NewController@getByAduanNo');
